...
$app->get ( "/logout", function () {
	...
	User::logout ();
	//Adicionado as duas linhas abaixo para apagar quando sair da pagina os carrinhos
...
$app->get("/boleto/:idorder",function ($idorder){
	...
	$dadosboleto["endereco1"] = $order->getdesaddress()." ".$order->desdistirct();
...
$app->post("/profile/change-password", function (){
	...
	if ($_POST['current_pass'] === $_POST['new_pass']) {
		...
		User::setError("A sua nova senha dever ser diferente da atual.");
		header("Location: /profile/change-password");
		exit;
