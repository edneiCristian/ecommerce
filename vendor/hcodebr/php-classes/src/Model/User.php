...
class User extends Model
{
    ...
    public static function login($login, $password)
    {
        ...
        if (count($results) === 0) {
            throw new \Exception("Usuรกrio inexistente ou senha invรกlida.");
        }
    ...
    public static function getForgot($email)
    {
        ...
        if (count($results) === 0) {
            ...
            throw new \Exception("Nใo foi possivel recuperar a senha.");
        } else {
    ...
    public static function validForgotDecrypt($code)
    {
        ...
        if (count($results) === 0) {
            ...
            throw new \Exception("Nรฃo foi possivel recuperar a senha.");
        } else {
